# Exercises on Parsing and Statistical Properties of Text #

This folder contains *only* exercises on Parsing and Statistical Properties of Text

## Where you can find exercises ##

| Test Date                                                                                                  | Exercise | Points       | Topic                 | Status                                                                             |
|:----------------------------------------------------------------------------------------------------------:|:--------:|:------------:|:---------------------:|:----------------------------------------------------------------------------------:|
| [08/06/12](http://didawiki.di.unipi.it/lib/exe/fetch.php/magistraleinformatica/ir/ir11/ir120608.doc)       |     1    |      4       | Zipf's and Heap's Law | ![Status](https://img.shields.io/badge/Status-Unsolved-red.svg)                    |
